...
files <- length(list.files("/Users/alexpinchs/GitHub/inversion_model/data_011223/full_runs"))
...
setwd("/Users/alexpinch/GitHub/inversion_model/data_011223/processed")
